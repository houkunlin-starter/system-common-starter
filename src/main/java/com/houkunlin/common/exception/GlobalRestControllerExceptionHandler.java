...
import com.houkunlin.common.BindFieldErrorMessage;
import com.houkunlin.common.ErrorMessage;
import com.houkunlin.common.GlobalErrorMessage;
...
public class GlobalRestControllerExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> httpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        if (cause instanceof DatabindException jsonMappingException) {
            ...
            if (jsonMappingException instanceof MismatchedInputException mismatchedInputException) {
                List<Map<String, String>> mapList = mismatchedInputException.getPath().stream()
                        .map(reference -> Map.of("fieldName", reference.getPropertyName(), "type", mismatchedInputException.getTargetType().getSimpleName()))
                        .toList();
